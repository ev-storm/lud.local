<div class="footer">
	...
	<div class="footer-item">
		<a href="#"><img class="footer-logo" src="/assets/svg/logo-mini.svg" alt=""></a>
		<h2>
			«<span class="footer-h1">Надёжные люди</span>» ©<br>
	...
	<div class="footer-item fi">
		<h2>
			Тел: <span>+7 (495) 972-36-26</span><br>
			Email: <span>info@nadezhnye-lyudi.ru</span><br>
		</h2>
	</div>

	<div class="i fi"></div>

	<div class="footer-item map fi">
	...
	<div class="footer-item f-btn fi">
	...
	<div class="footer-item">
		<div class="footer-btn cont-btn">
				<img class="trigger-qr qr-w" src="/assets/svg/wapp.svg" alt="wtpp">
				<img class="trigger-qr qr-t" src="/assets/svg/tg.svg" alt="telegram">
				<img class="trigger-qr qr-tel" src="/assets/svg/phone.svg" alt="phone">
				<a href="#" target="_blanc"><img src="/assets/svg/mail.svg" alt="mail"></a>
			</div>
		</div>
