	...
	<div class="container">
		<div class="catalog-title">
			...
			<div class="catalog-title_l2">
				<div>
					<button class="new">Новые</button>
					<button class="old">Старые</button>
					<button class="max-money">C наибольшей выручкой</button>
					<button class="min-money">C наименьшей выручкой</button>
				</div>
